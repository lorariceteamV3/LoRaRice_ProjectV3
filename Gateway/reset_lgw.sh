...
#
# gpiochip512  base 
GPIO_CHIP=/sys/class/gpio/gpiochip512
GPIO_BASE=$(cat $GPIO_CHIP/base)

# offset = GPIO  BCM (17,18,5,13)
SX1302_RESET_PIN=$((GPIO_BASE + 17))   # SX1302 reset
SX1302_POWER_EN_PIN=$((GPIO_BASE + 18)) # SX1302 power enable
SX1261_RESET_PIN=$((GPIO_BASE + 5))    # SX1261 reset (LBT / Spectral Scan)
AD5338R_RESET_PIN=$((GPIO_BASE + 13))  # AD5338R reset
